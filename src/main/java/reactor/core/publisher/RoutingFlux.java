...
public class RoutingFlux<T,K> extends ConnectableFlux<T> implements Scannable {
    ...
    static final class PublishSubscriber<T,K>
        ...
        @SuppressWarnings("rawtypes")
        static final AtomicReferenceFieldUpdater<RoutingFlux.PublishSubscriber, Subscription> S =
        ...
        volatile int wip;
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<RoutingFlux.PublishSubscriber> WIP =
                AtomicIntegerFieldUpdater.newUpdater(RoutingFlux.PublishSubscriber.class, "wip");

        volatile int connected;
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<RoutingFlux.PublishSubscriber> CONNECTED =
        ...
        @SuppressWarnings("rawtypes")
        static final AtomicReferenceFieldUpdater<RoutingFlux.PublishSubscriber, Throwable> ERROR =
                AtomicReferenceFieldUpdater.newUpdater(RoutingFlux.PublishSubscriber.class,
                        Throwable.class,
                        "error");
